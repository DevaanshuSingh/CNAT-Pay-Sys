        ...
        <main className={styles.mainArea}>
            <div className={styles.contentWrapper}>
                <div className={styles.placeholderCard}>
                    <img src="https://codernaccotax.co.in/assets/teacher1-CIGPx90j.jpg" alt="Mentorship" className={styles.cardImage} />
                ...
                <div className={styles.placeholderCard}>
                    <img src="https://codernaccotax.co.in/assets/teacher2-BELdqXSY.jpg" alt="Education" className={styles.cardImage} />
                    <div className={styles.cardContent}>
                ...
                <div className={styles.placeholderCard}>
                    <img src="https://codernaccotax.co.in/assets/teacher3-Ca2QJ_tX.jpg" alt="Lab Session" className={styles.cardImage} />
                    <div className={styles.cardContent}>
                ...
                <div className={styles.placeholderCard}>
                    <img src="https://codernaccotax.co.in/assets/background2-DtNOhygB.jpg" alt="Code setup" className={styles.cardImage} />
                    <div className={styles.cardContent}>
                ...
                <div className={styles.placeholderCard}>
                    <img src="https://codernaccotax.co.in/assets/teacher5-eKVJccIH.jpg" alt="Team" className={styles.cardImage} />
                    <div className={styles.cardContent}>
